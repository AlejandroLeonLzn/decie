...
<a href="archivos/4TO MODULO.docx" download="4TO MODULO.docx">Descargar Tarea</a>
<br>
<br>
<?php
  if(isset($_FILES['subir'])){
    ...
    $local_image = "archivos/tarea4/Tarea4Id".$_SESSION['iduser']."";
