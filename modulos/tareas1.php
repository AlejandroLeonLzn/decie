...
<a href="archivos/1ER MODULO.docx" download="1ER MODULO.docx">Descargar Tarea</a>
<br>
<br>
<?php
  if(isset($_FILES['subir'])){
    ...
    $local_image = "archivos/tarea1/Tarea1Id".$_SESSION['iduser']."";
