...
<a href="archivos/6TO MODULO.docx" download="6TO MODULO.docx">Descargar Tarea</a>
<br>
<br>
<?php
  if(isset($_FILES['subir'])){
    ...
    $local_image = "archivos/tarea6/Tarea6Id".$_SESSION['iduser']."";
