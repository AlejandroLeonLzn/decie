...
<a href="archivos/5TO MODULO.docx" download="5TO MODULO.docx">Descargar Tarea</a>
<br>
<br>
<?php
  if(isset($_FILES['subir'])){
    ...
    $local_image = "archivos/tarea5/Tarea5Id".$_SESSION['iduser']."";
