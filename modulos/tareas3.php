...
<a href="archivos/3ER MODULO.docx" download="3ER MODULO.docx">Descargar Tarea</a>
<br>
<br>
<?php
  if(isset($_FILES['subir'])){
    ...
    $local_image = "archivos/tarea3/Tarea3Id".$_SESSION['iduser']."";
